...
import IonDatetime from '../datepicker/datepicker.component'
...
export default {
  ...
  decorators: [
    moduleMetadata({
      declarations: [HomePage, NewsComponent, Input, CardComponent, Button, MenuComponent, IonDatetime, ToolbarComponent],
